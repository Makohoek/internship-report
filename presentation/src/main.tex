...
%\DeclareCaptionFormat{figure}{\colorbox[cmyk]{0.43, 0.35, 0.35,0.01}{\parbox{\textwidth}{\hspace{0pt}#1#2#3}}}
...
\lstset{
  basicstyle=\ttfamily,
  language=bash,                     % c language
  frame=lines,                        % bottom frame
  sensitive=true
  tabsize=2,
  breaklines=true,
  ...
  morekeywords={nm, grep, mkff, owcet}
}
...
%\renewcommand*\familydefault{\sfdefault}\color{defaultFontColor} %% Only if the base font of the document is to be typewriter style
