...
\begin{description}
    ...
    \item[Being focused] on the task that need to be done. It is a lot more difficult to be interrupted by something when working
        in pair. Since the \emph{observer} is here to guard that both stay focused. Note that it is
...
Those guidelines are the core of agile development and should always been respected to fully profit of the
agile advantages.
