...
\begin{ganttchart}[
    ...
    \ganttbar{Improving build process}{}{} \\
    \ganttbar{Xml checker}{}{} \\
    \ganttbar{Multi-variant support}{}{} \\
    \ganttbar{Fixed point enhancements}{}{}\\
    \ganttbar{Multi modem support  }{}{}\\
%
    \ganttbar{Newcomer documentation}{1}{3}\\
    \ganttbar{Intellectual property}{}{}\\
    \ganttbar{Alsa plugin refactor }{}{}\\
    \ganttbar{Filesystem plugin update}{}{}\\
    \ganttbar{Core update             }{}{}\\
    \ganttbar{Alsa plugin update      }{}{}\\
%
    \ganttbar{Internship report}{}{}\\
\end{ganttchart}
\end{figureGraphics}
