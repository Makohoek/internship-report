...
Given that fact, most of developers of our team are working remotely, via ssh on a powerful server.
...
Working remotely on that server constraints developers to use command line programs only because
...
They are responsible for testing complex uses cases and they ensure there is no regression nor side effects
