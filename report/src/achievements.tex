...
When I had to update the different components on GitHub, there were some problems:
Our internal version and the GitHub one had diverged.
...
\end{figureGraphics}
Since all the components I uploaded on GitHub had modifications which weren't present
...
the online documentation of the filesystem plugin, on GitHub.

The filesystem plugin is available on GitHub at \url{https://github.com/01org/parameter-framework-plugins-filesystem/}
...
front page on this GitHub project.  The README contains :
\begin{itemize}
...
The \gls{alsa} plugin is available on GitHub \url{https://github.com/01org/parameter-framework-plugins-alsa/}
