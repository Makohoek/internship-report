...
So I had to modify \emph{each plugin} to handle modem instance awareness. This would result in a lot of duplicated code and waste of time.

\subsubsection{Outcome}
TODO explain a bit more.


With the current implementation, it
...
Supporting multiple modems was a big team effort. I had to collaborate a lot with coworkers and other \gls{scrum} teams to be
sure that we deliver on time. In the end, we did deliver on time a beautiful piece of code.
