...
To demonstrate the power of this plugin, I wrote the README file which is on the front page on this GitHub project.
The README contains :
\begin{itemize}
...
The \gls{alsa} plugin is available at \url{https://github.com/01org/parameter-framework-plugins-alsa/}
