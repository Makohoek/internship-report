...
The example in listing \ref {lst:fixedPointProblem} illustrates the rounding error, and the output in the corrected version.
\begin{lstlisting}[caption=$Q.2.3$ rounding issue example, label=lst:fixedPointProblem]
pfw setParameter /Example/fixedPoint/q2.3
# Done
